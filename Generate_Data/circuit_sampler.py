...
class CircuitSampler:
    ...
    def sample(self, num_sample, result=None, qubit_mapping_lst=None, edges_mapping_list=None):
        '''
        :num_sample, sample how many circuits
        :param: result, 已有的线路集合，列表，每个元素是[lst_cir, depth, num_gate, num_2_qb_gate]
                            lst_cir是一个线路，例如: [['rz',0],['ry',1],['cz',1,2]]
        :param: phy2log_lst， 已有的映射集合，列表，每个元素是phy2log，例如：[4,1,6,2,0,3,5]
        :return: 新的线路集合，新的映射集合
        '''
